...
function items_li_spawn() {
    ...
    let components = item_dict['beh']['components']
    ...
    if (item_dict['texture'] != '') {
        document.getElementById('js_item_textures').innerHTML = '<img class="item_icon" src="static/data/' + window.AddData[item_id]['texture'] + '.png">'
    }
